...
static constexpr unsigned NUM_NEURONS_LAYER_ONE = NUM_INPUTS + 1;
static constexpr unsigned NUM_NEURONS_LAYER_TWO =   2 + 1;
static constexpr unsigned NUM_NEURONS_LAYER_THREE = 1 + 1;
